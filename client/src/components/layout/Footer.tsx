      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="text-center md:text-left">
            ...
            <p className="text-rose-300 max-w-sm">
              Tu poder habita dentro de ti. Despierta tu verdadero potencial.
            </p>
            <div className="flex items-center gap-4 mt-5 justify-center md:justify-start">
              <a
                ...
                className="w-10 h-10 rounded-full bg-rose-900/50 hover:bg-rose-800 hover:scale-110 flex items-center justify-center transition-all duration-300 group"
          ...
          <div className="flex flex-wrap justify-center gap-8">
            ...
            <a href="/#salas" className="hover:text-white transition-colors">
              Salas
            </a>
            <Link
              href="/miembros"
              className="hover:text-white transition-colors font-medium text-rose-300"
            >
              Acceso miembros
            </Link>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-rose-900/50 text-center text-rose-400/60 text-sm flex flex-col md:flex-row justify-between items-center gap-4">
          <p>
            © {new Date().getFullYear()} Fénix. Todos los derechos reservados.
          </p>
          <Link href="/admin">
