  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-rose-50/50 p-4 relative overflow-hidden">
      ...
      <Link href="/">
        <Button
          variant="ghost"
          className="absolute top-8 left-8 text-rose-800 hover:bg-rose-100/50 rounded-full"
        >
        ...
        <Card className="glass-card border-white/60 shadow-2xl rounded-[2rem] overflow-hidden">
          <CardContent className="p-8">
            <div className="text-center mb-8">
              <h1 className="font-serif text-3xl font-bold text-rose-950 mb-2">
                Acceso Miembros
              </h1>
              <p className="text-rose-800/60">
                Inicia sesión o crea tu cuenta para acceder a las salas.
              </p>
            </div>
            ...
            <Tabs defaultValue="login" className="w-full">
              <TabsList className="grid w-full grid-cols-2 bg-rose-100/50 rounded-full p-1 mb-8">
                <TabsTrigger
                  value="login"
                  className="rounded-full data-[state=active]:bg-white data-[state=active]:text-rose-900 data-[state=active]:shadow-sm"
                >
                  Iniciar Sesión
                </TabsTrigger>
                <TabsTrigger
              ...
              <TabsContent value="login">
                <form onSubmit={handleLogin} className="space-y-5">
                  <div className="space-y-2">
                    <Label htmlFor="login-email" className="text-rose-900 ml-1">
                      Email
                    </Label>
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="pl-10 h-12 rounded-2xl bg-white/50 border-rose-200 focus-visible:ring-rose-400"
                        value={email}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        placeholder="••••••••"
                        className="pl-10 pr-10 h-12 rounded-2xl bg-white/50 border-rose-200 focus-visible:ring-rose-400"
                        value={password}
                      ...
                      <button
                        ...
                        className="absolute right-3 top-3.5 text-rose-400 hover:text-rose-600 transition-colors"
                      >
                        {showLoginPassword ? (
                  ...
                  <Button
                    type="submit"
                    disabled={loading}
                    className="w-full h-12 rounded-2xl bg-rose-600 hover:bg-rose-700 text-white font-medium shadow-lg shadow-rose-600/20 mt-4"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          setShowRegisterConfirm(!showRegisterConfirm)
                        }
                        className="absolute right-3 top-3.5 text-rose-400 hover:text-rose-600 transition-colors"
                      >
                        {showRegisterConfirm ? (
